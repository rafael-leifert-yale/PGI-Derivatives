"""
QQQ Zero-DTE Gamma Scalping Backtest
Same strategy as SPY backtest, applied to QQQ
"""
...
def main():
    ...
    print("\n" + "="*70)
    print("ZERO-DTE GAMMA SCALPING BACKTEST - QQQ")
    print("="*70)
    ...
    # Full period: March 2024 - April 2026 (same as SPY backtest)
    results = orchestrator.run_backtest("2024-03-01", "2026-04-05")

    if results:
        print("\n" + "="*70)
        print("PERFORMANCE METRICS - QQQ")
        print("="*70)
        ...
        output_file = os.path.join(
            ...
            f"backtest_results_QQQ_{timestamp}.json"
        )
